...
#define INDICATOR_SESSION_ACTIONS(o)                                           \
  (G_TYPE_CHECK_INSTANCE_CAST((o), INDICATOR_TYPE_SESSION_ACTIONS,             \
                              IndicatorSessionActions))
#define INDICATOR_SESSION_ACTIONS_GET_CLASS(o)                                 \
  (G_TYPE_INSTANCE_GET_CLASS((o), INDICATOR_TYPE_SESSION_ACTIONS,              \
                             IndicatorSessionActionsClass))
#define INDICATOR_SESSION_ACTIONS_CLASS(k)                                     \
  (G_TYPE_CHECK_CLASS_CAST((k), INDICATOR_TYPE_SESSION_ACTIONS,                \
                           IndicatorSessionActionsClass))
#define INDICATOR_IS_SESSION_ACTIONS(o)                                        \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), INDICATOR_TYPE_SESSION_ACTIONS))
...
#define INDICATOR_SESSION_ACTIONS_PROP_HAS_ONLINE_ACCOUNT_ERROR                \
