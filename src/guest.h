...
#define INDICATOR_SESSION_GUEST(o)                                             \
  (G_TYPE_CHECK_INSTANCE_CAST((o), INDICATOR_TYPE_SESSION_GUEST,               \
                              IndicatorSessionGuest))
#define INDICATOR_SESSION_GUEST_GET_CLASS(o)                                   \
  (G_TYPE_INSTANCE_GET_CLASS((o), INDICATOR_TYPE_SESSION_GUEST,                \
                             IndicatorSessionGuestClass))
#define INDICATOR_SESSION_GUEST_CLASS(k)                                       \
  (G_TYPE_CHECK_CLASS_CAST((k), INDICATOR_TYPE_SESSION_GUEST,                  \
                           IndicatorSessionGuestClass))
#define INDICATOR_IS_SESSION_GUEST(o)                                          \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), INDICATOR_TYPE_SESSION_GUEST))
 ...
 * These functions should only be called by IndicatorSessionGuest
 * implementations.
 */
