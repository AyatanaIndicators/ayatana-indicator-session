...
#define INDICATOR_SESSION_USERS(o)                                             \
  (G_TYPE_CHECK_INSTANCE_CAST((o), INDICATOR_TYPE_SESSION_USERS,               \
                              IndicatorSessionUsers))
#define INDICATOR_SESSION_USERS_GET_CLASS(o)                                   \
  (G_TYPE_INSTANCE_GET_CLASS((o), INDICATOR_TYPE_SESSION_USERS,                \
                             IndicatorSessionUsersClass))
#define INDICATOR_SESSION_USERS_CLASS(k)                                       \
  (G_TYPE_CHECK_CLASS_CAST((k), INDICATOR_TYPE_SESSION_USERS,                  \
                           IndicatorSessionUsersClass))
#define INDICATOR_IS_SESSION_USERS(o)                                          \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), INDICATOR_TYPE_SESSION_USERS))
...
struct _IndicatorSessionUsersClass {
  ...
  void (*user_added)(IndicatorSessionUsers *self, guint uid);

  void (*user_removed)(IndicatorSessionUsers *self, guint uid);

  void (*user_changed)(IndicatorSessionUsers *self, guint uid);
  ...
  IndicatorSessionUser *(*get_user)(IndicatorSessionUsers *self, guint uid);

  void (*activate_user)(IndicatorSessionUsers *self, guint uid);
};
...
indicator_session_users_get_user(IndicatorSessionUsers *users, guint uid);
